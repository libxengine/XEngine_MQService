...
#define XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_MQ_REQREVERSE 0x7012        //请求倒序
#define XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_MQ_REPREVERSE 0x7013        //回复倒序
